...
function MIDBactualizarDatos() {
	...
	if (idrelacion == "") {
		error("Ha ocurrido un error, intente nuevamente y si el problema persiste contactese con el administrador");
	...
	$.ajax(
		{
			...
			dataType: 'JSON',
			success: function (content) {
				if (content.error) alert('Actualmente no hay bajas que apliquen con ese filtro');
				else {
					$.each(content, function (index, el) {
						nuevaBaja =
							'<tr>' +
...
function controlMIDBactualizarDatos() {
	...
	if ($('#MIDBestado').val() == 'No otorgada' && $('#MIDBmno').val() == undefined)
...
function corroborarMIDBestado() {
	...
	if (estado != "") {
		...
		document.getElementById("MIDBmno").innerHTML = "<option value='' selected>Seleccione un motivo</option>";

		if (estado == "Otorgada") {

			document.getElementById("MIDBmno").innerHTML = "<option value='' selected>¿Motivo de otorgada?</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='En plazo y al dia'>En plazo y al dia</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Solicitud de Depto Legal'>Solicitud de Depto Legal</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Excepción de Gerencia'>Excepción de Gerencia</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Cobranzas'>Cobranzas</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Valor Agregado'>Valor Agregado</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Fallecimiento'>Fallecimiento</option>";

		} else if (estado == "No otorgada") {

			document.getElementById("MIDBmno").innerHTML = "<option value='' selected>¿Motivo no otorgada?</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Deuda'>Deuda</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Plazo'>Plazo</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Ilocalizable'>Ilocalizable</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Pendiente comprobante'>Pendiente comprobante</option>";

		} else if (estado == "Continua") {

			document.getElementById("MIDBmno").innerHTML = "<option value='' selected>¿Como continua?</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Igual'>Igual</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Reduce'>Reduce</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Pasa a acotado'>Pasa a acotado</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Pasa a GF'>Pasa a GF</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Otros'>Otros</option>";

		} else if (estado == "En gestión") {

			document.getElementById("MIDBmno").innerHTML = "<option value='' selected>¿Motivo de gestión?</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Gestionando pago'>Gestionando pago</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Aguardando plazo'>Aguardando plazo</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Ilocalizable'>Ilocalizable</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Aguardando auditoria'>Aguardando auditoría</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Pendiente excepción'>Pendiente excepción</option>";
			document.getElementById("MIDBmno").innerHTML += "<option value='Derivado a Elite'>Derivado a Elite</option>";
