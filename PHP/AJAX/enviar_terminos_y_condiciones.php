...
function registrar_envio($cedula, $nombre, $celular, $sector)
{
    ...
    $sql = "INSERT INTO {$tabla} (cedula, nombre, telefono, fecha_registro, sector, observaciones, envioSector, activo, socio, baja, nombre_imagen) VALUES ('$cedula', '$nombre', '$celular', NOW(), '$sector', '$observacion', '', 1, $socio, $baja, NULL)";
    $consulta = mysqli_query($conexion, $sql);
