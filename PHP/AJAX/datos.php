...
$id_sub_usuario = $_REQUEST['id_sub_usuario'] == "null" ? "" : $_REQUEST['id_sub_usuario'];


if ($area == "" || $nombre == "" || $fecha == "" || $observacion == "" || $cedula == "" || $socio == "" || $sector == "") {
...
if (count($_FILES) > 0) {
	if (isset($_FILES["cargar_imagen_registro_1"]) != "") {
		$imagen = $_FILES["cargar_imagen_registro_1"];
	} else if (isset($_FILES["cargar_imagen_registro_2"]) != "") {
		$imagen = $_FILES["cargar_imagen_registro_2"];
	} else if (isset($_FILES["cargar_imagen_registro_3"]) != "") {
		$imagen = $_FILES["cargar_imagen_registro_3"];
	}
